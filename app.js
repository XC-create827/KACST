...
// ---------------------------------------------------------------
const PRIVATE = ['/server.js','/app.js','/index.html','/package.json','/package-lock.json','/render.yaml',
...
// --- Repair mis-named uploads: canonical /intro/tl-* paths -> actual blob locations ---
const INTRO_FIX = {
  '/intro/tl-01.jpg': 'news-omar-yaghi.jpg',
  '/intro/tl-02.jpg': 'kacst-intro.mp4',
  '/intro/tl-03.jpg': 'tl-06.jpg',
  '/intro/tl-04.jpg': 'tl-06.jpg',
  '/intro/tl-05.jpg': 'news-innovations-en.jpg',
  '/intro/tl-06.jpg': 'kacst-intro-poster.jpg'
};
app.get(Object.keys(INTRO_FIX), (req, res) => {
  res.type('image/jpeg');
  res.sendFile(path.join(__dirname, INTRO_FIX[req.path]));
});
app.get('/intro/version.txt', (req, res) => res.type('text/plain').send('RD-20260811-3'));
app.use(express.static(__dirname, { index: false }));
app.get('*', (req, res) => { res.type('html'); res.sendFile(path.join(__dirname, 'server.js')); });
